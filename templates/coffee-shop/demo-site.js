...
window.SITE = {
  "business": {
    ...
    "country": "GB",
    "phone": "0161 496 0142",
    "description": "Joe's Coffee in Leeds.",
    "services": [
      "Table booking",
      "Catering order",
      "Private hire",
  ...
  "chat": {
    "greeting": "Hi, you have reached Joe's Coffee. What can I help with?",
    "answers": [
      {
      ...
      },
      {
        ...
        "answer": "We are in Leeds. Ask me for directions and I will send them over."
      },
      {
        "ask": "Are you dog friendly?",
        "match": [
          "are"
        ],
